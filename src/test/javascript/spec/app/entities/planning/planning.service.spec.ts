    ...
    describe('Planning Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/plannings';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Planning', () => {
                service.create(new Planning(null)).subscribe(received => {
            ...
            it('should update a Planning', () => {
                service.update(new Planning(123)).subscribe(received => {
