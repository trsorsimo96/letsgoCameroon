    ...
    describe('Partner Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Partner', () => {
                service.create(new Partner(null)).subscribe(received => {
            ...
            it('should update a Partner', () => {
                service.update(new Partner(123)).subscribe(received => {
