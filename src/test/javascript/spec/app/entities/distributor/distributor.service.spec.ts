...
describe('Service Tests', () => {
    describe('Distributor Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DistributorService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/distributors';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Distributor', () => {
                service.create(new Distributor(null)).subscribe(received => {
            ...
            it('should update a Distributor', () => {
                service.update(new Distributor(123)).subscribe(received => {
            ...
            it('should return a Distributor', () => {
